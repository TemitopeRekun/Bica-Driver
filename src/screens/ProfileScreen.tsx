          ...
          <div className="px-4">
            <div className="bg-slate-200 dark:bg-surface-dark p-1 rounded-xl flex">
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-lg text-sm font-semibold text-center transition-all ${activeRole === UserRole.DRIVER ? 'bg-surface-light dark:bg-slate-700 shadow-sm text-slate-900 dark:text-white' : 'text-text-secondary'
                  }`}
              >
                Driver Mode
              </button>
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-lg text-sm font-semibold text-center transition-all ${activeRole === UserRole.OWNER ? 'bg-surface-light dark:bg-slate-700 shadow-sm text-slate-900 dark:text-white' : 'text-text-secondary'
                  }`}
              >
                Owner Mode
              </button>
